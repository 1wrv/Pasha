...
ugen=['Mozilla/5.0 (Macintosh; Intel Mac OS X 10.8; rv:45.0) Gecko/20100101 Firefox/45.0', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:50.0) Gecko/20100101 Firefox/50.0', 'Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.127 Safari/537.36']
ugen2=[]
ugen=[]
cokbrut=[]
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s [¹𓆩♔𓆪ȷІ⎽ɹ̤ᒧᓄ 𝐕𝐈𝐏] %s/%s •_• [𝗢𝗞 ] %s •_• [𝗖𝗣] %s •_• %s%s%s' % (bi, loop, len(id2), ok, cp, int(pers), str(fff), x), end=' ')
	sys.stdout.flush()
